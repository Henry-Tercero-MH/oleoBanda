import { CheckCircleIcon, WarningIcon, XCircleIcon, InfoIcon, XIcon } from '@phosphor-icons/react'

const CONFIG = {
  success: { icon: CheckCircleIcon, classes: 'bg-green-50 border-green-200 text-green-800' },
  warning: { icon: WarningIcon,     classes: 'bg-yellow-50 border-yellow-200 text-yellow-800' },
  error:   { icon: XCircleIcon,     classes: 'bg-red-50 border-red-200 text-red-800' },
  info:    { icon: InfoIcon,        classes: 'bg-blue-50 border-blue-200 text-blue-800' },
}
